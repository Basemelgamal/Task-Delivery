                ...
                <tbody>
                    @foreach ($tasks as $task)
                        <tr>
                            ...
                            <td>
                                <a href="{{route('tasks.edit',$task->id)}}" class="btn btn-icon btn-light btn-hover-primary btn-sm mx-3">
                                    <i class="fas fa-edit text-primary"></i>
                                </a>
                                <button class="btn btn-icon btn-light btn-hover-danger btn-sm delete" onclick="Delete('{{ $task->id }}')">
